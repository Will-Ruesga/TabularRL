...
def experiment():
    ...
    optimal_average_reward_per_timestep = 1.32917761149486

    # #### Assignment 2: Effect of exploration
    # print('Assignment 2: Effect of exploration')
    # policy = 'egreedy'
    ...
    # print('Assignment 3: Q-learning versus SARSA')
    # policy = 'egreedy'
    ...
    print('Assignment 4: Back-up depth')
    policy = 'egreedy'
    epsilon = 0.1 # set epsilon back to original value
    learning_rate = 0.25
    backup = 'nstep'
